...
void ZSerial::setFlowControlType(FlowControlType type)
{
...
#ifdef ZIMODEM_ESP32
  // We do not use hardware RTS/CTS flow control for the CoCo project, and these ESP32 IDF
  // functions have changed signatures or been removed in modern Arduino cores.
  ...
  if(flowControlType == FCT_RTSCTS)
  {
    ...
    {
      uart_set_pin(MAIN_UART_NUM, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE, pinCTS);
...
#       endif
    ...
    {
      uart_set_pin(MAIN_UART_NUM, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE, pinRTS, UART_PIN_NO_CHANGE);
