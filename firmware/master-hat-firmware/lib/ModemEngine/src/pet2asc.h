...
// Modern ESP32 Arduino cores don't always expose UART_NUM_x as macros.
#ifndef UART_NUM_0
#define UART_NUM_0 0
#endif
#ifndef UART_NUM_1
...
# include "SPI.h"
#   define MAIN_UART_NUM UART_NUM_0 // ESP32 core maps UART0 to Serial0 in Arduino
#   define DEBUG_UART_NUM -1 // Disable Zimodem's built-in debug spam to protect our own console
  // Replace HardwareSerial with our SPI-based ModemSerial adapter
  #include "ModemEngine.h"
  extern ModemSerial HWSerial;
#else
